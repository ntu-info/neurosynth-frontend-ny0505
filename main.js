// API base is configurable via window.API_BASE. Default points to the public Tren backend.
// When using a server-side proxy (Netlify functions) set window.API_BASE = '/api' before loading main.js.
const BASE = (typeof window !== 'undefined' && window.API_BASE) ? window.API_BASE : 'https://mil.psy.ntu.edu.tw:5000';
